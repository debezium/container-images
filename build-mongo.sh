...
if [ "$PUSH_IMAGES" == "true" ]; then
    ...
    docker tag "${DEBEZIUM_DOCKER_REGISTRY_PRIMARY_NAME}/mongo-initiator:$1" "${DEBEZIUM_DOCKER_REGISTRY_SECONDARY_NAME}/mongo-initiator:$1"
    docker push "${DEBEZIUM_DOCKER_REGISTRY_SECONDARY_NAME}/mongo-initiator:$1"
fi
