...
This image is based upon [`postgres:18`](https://hub.docker.com/_/postgres/) and adds one logical decoding plug-in:
...
This image is used in the same manner as the [`postgres:18`](https://hub.docker.com/_/postgres/) image, though the `/usr/share/postgresql/postgresql.conf.sample` file configures the logical decoding feature:
