...
This image is based upon [`postgres:15beta2-alpine`](https://hub.docker.com/_/postgres/) and adds two logical decoding plug-ins:
...
This image is used in the same manner as the [`postgres:13-alpine`](https://hub.docker.com/_/postgres/) image, though the `/usr/share/postgresql/postgresql.conf.sample` file configures the logical decoding feature:
