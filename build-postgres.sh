...
if [ "$PUSH_IMAGES" == "true" ]; then
    ...
    docker tag "${DEBEZIUM_DOCKER_REGISTRY_PRIMARY_NAME}/postgres:$1" "${DEBEZIUM_DOCKER_REGISTRY_SECONDARY_NAME}/${DEBEZIUM_DOCKER_REGISTRY_PRIMARY_NAME}/postgres:$1"
    docker push "${DEBEZIUM_DOCKER_REGISTRY_SECONDARY_NAME}/${DEBEZIUM_DOCKER_REGISTRY_PRIMARY_NAME}/postgres:$1"
fi
